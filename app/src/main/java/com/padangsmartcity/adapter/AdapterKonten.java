...
public class AdapterKonten extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    private Context context;
    private List<ModelKonten> mItems;

    public AdapterKonten(List<ModelKonten> mItems, Context context) {
        this.mItems = mItems;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_konten, parent, false);
