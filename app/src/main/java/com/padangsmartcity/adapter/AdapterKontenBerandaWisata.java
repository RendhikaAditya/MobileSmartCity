...
import com.padangsmartcity.activity.DetailKonten;
...
public class AdapterKontenBerandaWisata extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    private Context context;
    private List<ModelKonten> mItems;

    public AdapterKontenBerandaWisata(List<ModelKonten> mItems, Context context) {
        this.mItems = mItems;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_konten_wisata, parent, false);
